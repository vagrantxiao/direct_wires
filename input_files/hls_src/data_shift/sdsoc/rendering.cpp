...
#pragma HLS INTERFACE ap_hs port=Output_1
  ...
  coloringFB_top_m_out_1++;
	  ...
	  for (i=0; i<MAX_X; i++){
		  RECV: for(int k=0; k<MAX_Y/2; k+=16){
#pragma HLS PIPELINE II=1
...
#pragma HLS INTERFACE ap_hs port=Output_2
  ...
  input_lo = input_tmp(31,  0);
  input_mi = input_tmp(63, 32);
  input_hi = input_tmp(95, 64);
  projection_odd_m (
  		input_lo,
  		input_mi,
  		input_hi,
